...
const Gifts = () => {
  return (
    <div className="text-center px-4 md:pb-[96px]  pb-[60px] flex flex-col items-center  w-full">
      ...
      >
        <div className="flex flex-col gap-4 p-[20px] mb-4 justify-start items-start  border border-[#f8cfa5] w-[300px]  lg:w-[350px] h-[280px] text-center  rounded-[10px]">
          ...
          <p className="w-[248px] text-start font-[pnu] opacity-80">
            ...
            الأنثوية مما يساهم في تخفيف حدة الأعراض المرتبطة بالصدفية والإكزيما
          </p>
        </div>
        <div className="flex flex-col gap-4 p-[20px] mb-4 justify-start items-start  border border-[#f8cfa5] w-[300px]  lg:w-[350px] h-[280px] text-center  rounded-[10px]">
          ...
          <p className="w-[248px] text-start font-[pnu] opacity-80">
            ...
            الحالة الصحية وتخفيف حدة الأعراض المرتبطة بالصدفية والإكزيما{" "}
          </p>
        </div>
        ...
        <div className="flex flex-col gap-4 p-[20px] mb-4 justify-start items-start  border border-[#f8cfa5] w-[300px]  lg:w-[350px] h-[280px] text-center  rounded-[10px]">
          ...
          <p className="w-[248px] text-start font-[pnu] opacity-80">
            يركز على تعزيز الطمأنينة، والقيمة، والقدرة، والحرية كركائز لحياة
