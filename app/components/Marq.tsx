...
const Marq = () => {
  return (
    <div className=" w-full max-w-screen z-40 mx-auto flex flex-col items-center justify-center overflow-hidden mb-[70px] lg:mb-[140px]">
      <h1 className="text-center mb-[40px] text-white font-monadi text-[12px] lg:text-sm font-normal leading-7 opacity-80">
        Presented by{" "}
        <span className="text-[#c87331] font-bold">DR. Ahmed AlDemlawy</span>{" "}
        the Creator of{" "}
      </h1>
